...
public class HelloWorldElement extends Component {
    ...
    public HelloWorldElement() {
        ...
        UI.getCurrent().getPage().addHtmlImport("frontend://bower_components/paper-input/paper-input.html");
        Element input = new Element("paper-input");

        Element greeting = ElementFactory.createDiv();
        greeting.getStyle().set("fontWeight", "bold");
        greeting.getStyle().set("border-left", "1px solid redz`");
